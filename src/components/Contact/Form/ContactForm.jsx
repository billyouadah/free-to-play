    ...
    return (
        <>
            <div id='contact-container'>
                <Typography variant='h1' fontFamily="audiowide-regular"  sx={{ color:"white", margin:{xs:"10px", sm:"20px", md:"30px"}, fontSize:{xs:"42px", sm:"75px", md:"96px"} }}>
                    Contact
                </Typography>
                <form onSubmit={formik.handleSubmit} style={{ display:'flex', flexDirection:'column', alignItems:'center' }}>
                    <div id='inputs' style={{ backgroundColor:"#9d4edd", padding:'10px', borderRadius:'15px' }}>
                        <TextField 
                        size='small'
                        fullWidth
                        className='input'
                    ...
                    <Button 
                    sx={{backgroundColor:'#5A189A', color: '#FFF', '&:hover': {backgroundColor:'#fff', color: '#5A189A'}, fontWeight: 'bold', width:"200px" }} 
                    type="submit" 
